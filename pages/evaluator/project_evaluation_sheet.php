    ...
    <body class="me-3">
        ...
        <div class="container-fluid px-5 border border-secondary rounded">
            <div class="row py-3">
                ...
                <div class="col text-end">
                    <form method="post" action="insert_data.php?PROJECT_ID=<?php echo $project_id ?>&evaluation_round=<?php echo 1 ?>">
        ...
        <div class="container-fluid my-3 px-5 pt-3 border border-secondary rounded">
            <div class="row py-3">
                ...
                <div class="col text-end">
                    <form method="post" action="insert_data.php?PROJECT_ID=<?php $_GET['PROJECT_ID'] ?>">
                        <button type="submit" class="btn btn-primary">Submit</button>
                    </form>
                </div>
            </div>
